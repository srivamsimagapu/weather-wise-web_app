...
form.addEventListener('submit', function (e) {
    ...
    fetch(url).then((response) => {
        ...
        if (weatherMain == 'Clear') {
            image.src = `./images/68V-unscreen,gif`
            myWeatherContainer.style.backgroundColor = '#ec6e4c'
        }
        if (weatherMain == 'Clouds') {
            image.src = `./images/Partly-Cloudy-GIF-unscreen.gif`
            myWeatherContainer.style.backgroundColor = '#86d3d3'
        }
        if (weatherMain == 'Rain') {
            image.src = `./images/rainy.gif`
            myWeatherContainer.style.backgroundColor = '#c9d8d8'
        }
        ...
        if (weatherMain == 'Haze') {
            image.src = `./images/7Z6Q.gif`
            myWeatherContainer.style.backgroundColor = '#e7e5eb'
        }
